...
Route::any('/login_submit', [UserController::class, 'login_submit'])->name('login_submit');

Route::get('/registration', [UserController::class, 'registration'])->name('registration');
Route::any('/registration_submit', [UserController::class, 'registration_submit'])->name('registration_submit');
...
Route::any('/forget_password_submit', [UserController::class, 'forget_password_submit'])->name('forget_password_submit');

Route::get('/reset/password/{t}/{e}', [UserController::class, 'reset_password']);
Route::any('/reset_password_submit', [UserController::class, 'reset_password_submit'])->name('reset_password_submit');

Route::get('/logout', [UserController::class, 'logout'])->name('logout')->middleware('auth');

// for admin
Route::get('admin/login', [AdminController::class , 'admin_login'])->name('admin_login');
Route::any('admin_login_submit', [AdminController::class, 'admin_login_submit'])->name('admin_login_submit');
